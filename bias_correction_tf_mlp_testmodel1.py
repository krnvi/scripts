...
saver = tf.train.import_meta_graph('/home/vkvalappil/Data/workspace/pythonScripts/mlp_bias_cor_3/mlp_bias_cor.meta') 
saver.restore(sess,tf.train.latest_checkpoint('/home/vkvalappil/Data/workspace/pythonScripts/mlp_bias_cor_3/'))
