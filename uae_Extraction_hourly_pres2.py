...
outFile=output+'hourly_pres'+date+'_00UTC.csv' ; 
...
tmp=(np.array(grb_f.select(name="Temperature",typeOfLevel='isobaricInhPa')))[450:475] 
RH=(np.array(grb_f.select(name="Relative humidity",typeOfLevel='isobaricInhPa')))[450:475]
dtmp=(np.array(grb_f.select(name="Dew point temperature",typeOfLevel='isobaricInhPa')))[450:475]
ugrd=(np.array(grb_f.select(name="U component of wind",typeOfLevel='isobaricInhPa')))[450:475]
vgrd=(np.array(grb_f.select(name="V component of wind",typeOfLevel='isobaricInhPa')))[450:475]
...
date_list=date_list[18] ; f_date=np.vstack(np.tile(date_list,noloc*25)) ; 

outFile=output+'Pres_'+date+'_'+date_list[0:10]+'_00UTC.csv' ; 
