...
bufr_filename ='/home/vkvalappil/Data/modelWRF/input/2017122006/gdas.t06z.mtiasi.tm00.bufr_d' 
...
while bufr.advance() == 0:
    ...
    while bufr.load_subset() == 0:
        hdr1 = bufr.read_subset(hdstr1).squeeze() ; print(hdr1)
        ...
        csf=bufr.read_subset('CHSF',rep=True).squeeze()
        sct=bufr.read_subset('STCH',rep=True).squeeze()
        ect=bufr.read_subset('ENCH',rep=True).squeeze()
