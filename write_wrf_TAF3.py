...
ws_kn=(req_data_1[1,5]) ; vis_km=(req_data_1[1,8]) ; vis_ml=(req_data_1[1,9])
cldcdn=(req_data_1[1,10]) ; cil_feet=(req_data_1[1,11]) ; wcdn=(req_data_1[1,12])
...
Visibility: {} sm  (  {} km)
Clouds:{}  
Weather:{}       """.format(d_1,d_2,d_3,d_3,d_4,wd_shrt,wd,ws_mi,ws_kn,ws_m,vis_ml,vis_km,cldcdn,wcdn)
...
Visibility: {} sm   (  {} km)
Clouds:{} 
Weather:{}  """.format(d_1,d_4,d_1,wd_shrt,wd,ws_mi,ws_kn,ws_m,vis_ml,vis_km,cldcdn,wcdn)
