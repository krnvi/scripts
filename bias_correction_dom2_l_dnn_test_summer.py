...
date_2=dt.datetime.strptime(date,'%Y%m%d%H')+dt.timedelta(days=91)
...
for ii in range(0,len(date_index_req)):
    ...
    #tmp_target=tmp_input_1['mod'].reset_index(drop=True) 
...
#    Y1=dt_tmp_input['obs'].iloc[24:48].reset_index(drop=True) 
#    Y1=Y1.dropna(how='any').reset_index(drop=True)
...
############### loading and predict Linear DNN combined regressor
    epochs=2000 ;
    h_size1=30 ; h_size2=30 ;itrn=50
    #m_dir='tmp_linear_dnn_bias-cor_full_'+str(itrn)+'.bsz_ep.'+str(epochs)+'_hu.'+str(h_size2)+'.'+str(h_size2)+'.1_Mn_2016_2017_summer'
    m_dir='tmp_linear_dnn_bias-cor_full_'+str(itrn)+'.bsz_ep.'+str(epochs)+'_hu.'+str(h_size1)+'.'+str(h_size1)+'.'+str(h_size2)+'.1_Mn_2016_2017_summer'
...
################################################################################################################################# 
    ...
    tmp_data_new=pd.concat([tmp_input_1['mod'],pd.DataFrame(np.round(y_new_l_dnn)),Y,dt_tmp_input['bias'].iloc[24:48].reset_index(drop=True),\
                 bias_new],axis=1)
...
print ('All : ' + str(cnt) +':::'+ str(cnt/90.0*100))
...
#
#tmp_data_new_hour_jan.insert(6,'uc_rmse',uc_tmp_rmse_hour_avg_day1_jan)
#tmp_data_new_hour_jan.insert(7,'cor_rmse',cor_tmp_rmse_hour_avg_day1_jan)
#
#plot_bars_rmse_hw(tmp_data_new_hour_jan.iloc[11:35,:],'Temperature','Hour_wise','RMSE','201801' )
#
#
#cnt=(tmp_data_new_hour_jan['cor_rmse'] <tmp_data_new_hour_jan['uc_rmse']).sum()
#print ('Jan : ' + str(cnt) +':::'+ str(cnt/float(tmp_data_new_hour_jan.shape[0])*100))
#
...
#
#tmp_data_new_hour_feb.insert(6,'uc_rmse',uc_tmp_rmse_hour_avg_day1_feb)
#tmp_data_new_hour_feb.insert(7,'cor_rmse',cor_tmp_rmse_hour_avg_day1_feb)
#
#plot_bars_rmse_hw(tmp_data_new_hour_feb.iloc[11:35,:],'Temperature','Hour_wise','RMSE','201802' )
#
#cnt=(tmp_data_new_hour_feb['cor_rmse'] <tmp_data_new_hour_feb['uc_rmse']).sum()
#print ('Feb : ' + str(cnt) +':::'+ str(cnt/float(tmp_data_new_hour_feb.shape[0])*100))
#
#
...
#
#tmp_data_new_hour_mar.insert(6,'uc_rmse',uc_tmp_rmse_hour_avg_day1_mar)
#tmp_data_new_hour_mar.insert(7,'cor_rmse',cor_tmp_rmse_hour_avg_day1_mar)
#
#plot_bars_rmse_hw(tmp_data_new_hour_mar.iloc[11:35,:],'Temperature','Hour_wise','RMSE','201803' )
#
#cnt=(tmp_data_new_hour_mar['cor_rmse'] <tmp_data_new_hour_mar['uc_rmse']).sum()
#print ('Mar : ' + str(cnt) +':::'+ str(cnt/float(tmp_data_new_hour_mar.shape[0])*100))
#
...
tmp_data_new_hour_apr.insert(6,'uc_rmse',uc_tmp_rmse_hour_avg_day1_apr)
tmp_data_new_hour_apr.insert(7,'cor_rmse',cor_tmp_rmse_hour_avg_day1_apr)

plot_bars_rmse_hw(tmp_data_new_hour_apr.iloc[11:35,:],'Temperature','Hour_wise','RMSE','201803' )

cnt=(tmp_data_new_hour_apr['cor_rmse'] <tmp_data_new_hour_apr['uc_rmse']).sum()
print ('Apr : ' + str(cnt) +':::'+ str(cnt/float(tmp_data_new_hour_apr.shape[0])*100))
...
tmp_data_new_hour_may.insert(6,'uc_rmse',uc_tmp_rmse_hour_avg_day1_may)
tmp_data_new_hour_may.insert(7,'cor_rmse',cor_tmp_rmse_hour_avg_day1_may)

plot_bars_rmse_hw(tmp_data_new_hour_may.iloc[11:35,:],'Temperature','Hour_wise','RMSE','201803' )

cnt=(tmp_data_new_hour_may['cor_rmse'] <tmp_data_new_hour_may['uc_rmse']).sum()
print ('may : ' + str(cnt) +':::'+ str(cnt/float(tmp_data_new_hour_may.shape[0])*100))

#rmse_cor_may=rmse_cor['2018-03-01':'2018-03-31']
plot_bars_rmse(rmse_cor_may,'tmperature','day_1','rmse',rmse_cor_may.index.strftime('%Y%m')[0])

###################################################################################################################################


tmp_data_new_hour_jun=tmp_data_new_hour['2018-05-31 13':'2018-06-29 12']
...
tmp_data_new_hour_jun.insert(6,'uc_rmse',uc_tmp_rmse_hour_avg_day1_jun)
tmp_data_new_hour_jun.insert(7,'cor_rmse',cor_tmp_rmse_hour_avg_day1_jun)

plot_bars_rmse_hw(tmp_data_new_hour_jun.iloc[11:35,:],'Temperature','Hour_wise','RMSE','201803' )

cnt=(tmp_data_new_hour_jun['cor_rmse'] <tmp_data_new_hour_jun['uc_rmse']).sum()
print ('jun : ' + str(cnt) +':::'+ str(cnt/float(tmp_data_new_hour_jun.shape[0])*100))

#rmse_cor_jun=rmse_cor['2018-03-01':'2018-03-31']
