...
date_2=dt.datetime.strptime(date,'%Y%m%d%H')+dt.timedelta(days=89)
...
############### loading and predict Linear DNN combined regressor
    ...
    m_dir='tmp_linear_dnn_bias-cor_full_'+str(itrn)+'.bsz_ep.'+str(epochs)+'_hu.'+str(h_size1)+'.'+str(h_size2)+'.'+str(h_size2)+'.1_Mn_2016_2017_winter'
...
#
#rmse_cor_apr=rmse_cor['2018-03-01':'2018-03-31']
