...
X=mr_input_1_m.dropna(how='any').reset_index(drop=True)  ; Y=mr_target_m.dropna(how='any').reset_index(drop=True)  ; 
...
epochs = 2000 ;
h_size1=100 ; h_size2=100 ; itrn=50 #final arch
