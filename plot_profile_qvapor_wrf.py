...
date='2017011106' ; rs_date='2017011112' ; fcs_leaddays=3 ; #provide date as argument, forecast start and end date defined
...
file_rs='/home/Data/workspace/wyming/upperair/AbuBhabi_upperair_'+rs_date+'.csv'
outFile=output+'GFS_ENKF/plots/modelLevel_gsi_nogsi_rs_'+date+'_'+file_date_list[ii]+'.png'
