...
######################################################
d_t_1='2017-04-01 13' ; d_t_2='2017-08-30 12' ; 
...
####################### Optimizer      #########################
learning_rate = 0.0005 ; epochs = 10000 ; batch_size = 100 
...
save_path = saver.save(sess, '/home/vkvalappil/Data/workspace/pythonScripts/mlp_bias_cor_3/mlp_bias_cor')
sess.close() 
