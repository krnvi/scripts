...
for ii in range(0,len(date_index_req)):
    ...
    mr_input_1_m=pd.concat([mr_input_1['Date'],mr_input_1['mod.p']*1000,mr_input_1['obs']*1000,mr_input_1['bias']*1000, \
                        mr_input_1['rmse']*1000,mr_input_1['hour'],mr_input_1['mod']*1000],axis=1)
...
##############################################################################################################
    X=mr_input_1_m.dropna(how='any').reset_index(drop=True)  ; Y=mr_target.dropna(how='any').reset_index(drop=True)  ; 
...
############### loading and predict Linear DNN combined regressor
    ...
    m_dir='mr_linear_dnn_bias-cor_full_'+str(itrn)+'.bsz_ep.'+str(epochs)+'_hu.'+str(h_size1)+'.'+str(h_size1)+'.'+str(h_size2)+'.1_Mn_2016_2017_m'
    ...
    y_new_l_dnn =np.array(y_new_l_dnn)/1000.0 #* (max_Y - min_Y) + min_Y
    y_uc=X['mod']/1000.0                           
...
################################################################################################################################# 
    ...
    mr_data_new=pd.concat([mr_input_1['mod'],pd.DataFrame((y_new_l_dnn)),Y,dt_mr_input['bias'].iloc[24:48].reset_index(drop=True),\
                 bias_new],axis=1)
    mr_data_new.columns=['mod','mod_cor','obs','bias_mod','bias_cor']
...
mr_data_new_hour_jan.insert(6,'uc_rmse',uc_mr_rmse_hour_avg_day1_jan)
mr_data_new_hour_jan.insert(7,'cor_rmse',cor_mr_rmse_hour_avg_day1_jan)

plot_bars_rmse_hw(mr_data_new_hour_jan.iloc[11:35,:],'Mixing_ratio','Hour_wise','RMSE','201801' )


cnt=(mr_data_new_hour_jan['cor_rmse'] <mr_data_new_hour_jan['uc_rmse']).sum()
print ('Jan : ' + str(cnt) +':::'+ str(cnt/float(mr_data_new_hour_jan.shape[0])*100))
...
mr_data_new_hour_feb.insert(6,'uc_rmse',uc_mr_rmse_hour_avg_day1_feb)
mr_data_new_hour_feb.insert(7,'cor_rmse',cor_mr_rmse_hour_avg_day1_feb)

plot_bars_rmse_hw(mr_data_new_hour_feb.iloc[11:35,:],'Mixing_ratio','Hour_wise','RMSE','201802' )

cnt=(mr_data_new_hour_feb['cor_rmse'] <mr_data_new_hour_feb['uc_rmse']).sum()
print ('Feb : ' + str(cnt) +':::'+ str(cnt/float(mr_data_new_hour_feb.shape[0])*100))
...
##################################################################################################################
mr_data_new_hour_mar=mr_data_new_hour['2018-02-28 13':'2018-04-01 12']
hourt = pd.to_timedelta(mr_data_new_hour_mar.index.hour,  unit='H')
mf=int(mr_data_new_hour_mar.shape[0]/24.0)

uc_mr_rmse_hour_avg_day1_mar=(((mr_data_new_hour_mar['bias_mod']**2).groupby(hourt)).mean())**0.5
uc_mr_rmse_hour_avg_day1_mar=pd.concat([uc_mr_rmse_hour_avg_day1_mar[13:24],uc_mr_rmse_hour_avg_day1_mar[0:13]])
uc_mr_rmse_hour_avg_day1_mar=pd.concat([uc_mr_rmse_hour_avg_day1_mar]*mf)
uc_mr_rmse_hour_avg_day1_mar.index=mr_data_new_hour_mar.index

cor_mr_rmse_hour_avg_day1_mar=(((mr_data_new_hour_mar['bias_cor']**2).groupby(hourt)).mean())**0.5
cor_mr_rmse_hour_avg_day1_mar=pd.concat([cor_mr_rmse_hour_avg_day1_mar[13:24],cor_mr_rmse_hour_avg_day1_mar[0:13]])
cor_mr_rmse_hour_avg_day1_mar=pd.concat([cor_mr_rmse_hour_avg_day1_mar]*mf)
cor_mr_rmse_hour_avg_day1_mar.index=mr_data_new_hour_mar.index 

mr_data_new_hour_mar.insert(6,'uc_rmse',uc_mr_rmse_hour_avg_day1_mar)
mr_data_new_hour_mar.insert(7,'cor_rmse',cor_mr_rmse_hour_avg_day1_mar)

plot_bars_rmse_hw(mr_data_new_hour_mar.iloc[11:35,:],'Mixing_ratio','Hour_wise','RMSE','201803' )

cnt=(mr_data_new_hour_mar['cor_rmse'] <mr_data_new_hour_mar['uc_rmse']).sum()
print ('mar : ' + str(cnt) +':::'+ str(cnt/float(mr_data_new_hour_mar.shape[0])*100))

rmse_cor_mar=rmse_cor['2018-03-01':'2018-03-31']
plot_bars_rmse(rmse_cor_mar,'Mixing_Ratio','day_1','rmse',rmse_cor_mar.index.strftime('%Y%m')[0])
############################################################################################################################
mr_data_new_hour_apr=mr_data_new_hour['2018-03-31 13':'2018-05-01 12']
hourt = pd.to_timedelta(mr_data_new_hour_apr.index.hour,  unit='H')
mf=int(mr_data_new_hour_apr.shape[0]/24.0)

uc_mr_rmse_hour_avg_day1_apr=(((mr_data_new_hour_apr['bias_mod']**2).groupby(hourt)).mean())**0.5
uc_mr_rmse_hour_avg_day1_apr=pd.concat([uc_mr_rmse_hour_avg_day1_apr[13:24],uc_mr_rmse_hour_avg_day1_apr[0:13]])
uc_mr_rmse_hour_avg_day1_apr=pd.concat([uc_mr_rmse_hour_avg_day1_apr]*mf)
uc_mr_rmse_hour_avg_day1_apr.index=mr_data_new_hour_apr.index

cor_mr_rmse_hour_avg_day1_apr=(((mr_data_new_hour_apr['bias_cor']**2).groupby(hourt)).mean())**0.5
cor_mr_rmse_hour_avg_day1_apr=pd.concat([cor_mr_rmse_hour_avg_day1_apr[13:24],cor_mr_rmse_hour_avg_day1_apr[0:13]])
cor_mr_rmse_hour_avg_day1_apr=pd.concat([cor_mr_rmse_hour_avg_day1_apr]*mf)
cor_mr_rmse_hour_avg_day1_apr.index=mr_data_new_hour_apr.index 

mr_data_new_hour_apr.insert(6,'uc_rmse',uc_mr_rmse_hour_avg_day1_apr)
mr_data_new_hour_apr.insert(7,'cor_rmse',cor_mr_rmse_hour_avg_day1_apr)

plot_bars_rmse_hw(mr_data_new_hour_apr.iloc[11:35,:],'Mixing_ratio','Hour_wise','RMSE','201804' )

cnt=(mr_data_new_hour_apr['cor_rmse'] <mr_data_new_hour_apr['uc_rmse']).sum()
print ('Apr : ' + str(cnt) +':::'+ str(cnt/float(mr_data_new_hour_apr.shape[0])*100))


rmse_cor_apr=rmse_cor['2018-04-01':'2018-04-30']
plot_bars_rmse(rmse_cor_apr,'Mixing_Ratio','day_1','rmse',rmse_cor_apr.index.strftime('%Y%m')[0])

####################################################################################################################################
mr_data_new_hour_may=mr_data_new_hour['2018-04-30 13':'2018-06-01 12']
hourt = pd.to_timedelta(mr_data_new_hour_may.index.hour,  unit='H')
mf=int(mr_data_new_hour_may.shape[0]/24.0)

uc_mr_rmse_hour_avg_day1_may=(((mr_data_new_hour_may['bias_mod']**2).groupby(hourt)).mean())**0.5
uc_mr_rmse_hour_avg_day1_may=pd.concat([uc_mr_rmse_hour_avg_day1_may[13:24],uc_mr_rmse_hour_avg_day1_may[0:13]])
uc_mr_rmse_hour_avg_day1_may=pd.concat([uc_mr_rmse_hour_avg_day1_may]*mf)
uc_mr_rmse_hour_avg_day1_may.index=mr_data_new_hour_may.index

cor_mr_rmse_hour_avg_day1_may=(((mr_data_new_hour_may['bias_cor']**2).groupby(hourt)).mean())**0.5
cor_mr_rmse_hour_avg_day1_may=pd.concat([cor_mr_rmse_hour_avg_day1_may[13:24],cor_mr_rmse_hour_avg_day1_may[0:13]])
cor_mr_rmse_hour_avg_day1_may=pd.concat([cor_mr_rmse_hour_avg_day1_may]*mf)
cor_mr_rmse_hour_avg_day1_may.index=mr_data_new_hour_may.index 

mr_data_new_hour_may.insert(6,'uc_rmse',uc_mr_rmse_hour_avg_day1_may)
mr_data_new_hour_may.insert(7,'cor_rmse',cor_mr_rmse_hour_avg_day1_may)

plot_bars_rmse_hw(mr_data_new_hour_may.iloc[11:35,:],'Mixing_ratio','Hour_wise','RMSE','201805' )

cnt=(mr_data_new_hour_may['cor_rmse'] <mr_data_new_hour_may['uc_rmse']).sum()
print ('May : ' + str(cnt) +':::'+ str(cnt/float(mr_data_new_hour_may.shape[0])*100))


rmse_cor_may=rmse_cor['2018-05-01':'2018-05-31']
plot_bars_rmse(rmse_cor_may,'Mixing_Ratio','day_1','rmse',rmse_cor_may.index.strftime('%Y%m')[0])

##################################################################################################################################

mr_data_new_hour_jun=mr_data_new_hour['2018-05-31 13':'2018-06-29 12']
hourt = pd.to_timedelta(mr_data_new_hour_jun.index.hour,  unit='H')
mf=int(mr_data_new_hour_jun.shape[0]/24.0)

uc_mr_rmse_hour_avg_day1_jun=(((mr_data_new_hour_jun['bias_mod']**2).groupby(hourt)).mean())**0.5
uc_mr_rmse_hour_avg_day1_jun=pd.concat([uc_mr_rmse_hour_avg_day1_jun[13:24],uc_mr_rmse_hour_avg_day1_jun[0:13]])
uc_mr_rmse_hour_avg_day1_jun=pd.concat([uc_mr_rmse_hour_avg_day1_jun]*mf)
uc_mr_rmse_hour_avg_day1_jun.index=mr_data_new_hour_jun.index

cor_mr_rmse_hour_avg_day1_jun=(((mr_data_new_hour_jun['bias_cor']**2).groupby(hourt)).mean())**0.5
cor_mr_rmse_hour_avg_day1_jun=pd.concat([cor_mr_rmse_hour_avg_day1_jun[13:24],cor_mr_rmse_hour_avg_day1_jun[0:13]])
cor_mr_rmse_hour_avg_day1_jun=pd.concat([cor_mr_rmse_hour_avg_day1_jun]*mf)
cor_mr_rmse_hour_avg_day1_jun.index=mr_data_new_hour_jun.index 

mr_data_new_hour_jun.insert(6,'uc_rmse',uc_mr_rmse_hour_avg_day1_jun)
mr_data_new_hour_jun.insert(7,'cor_rmse',cor_mr_rmse_hour_avg_day1_jun)

plot_bars_rmse_hw(mr_data_new_hour_jun.iloc[11:35,:],'Mixing_ratio','Hour_wise','RMSE','201806' )

cnt=(mr_data_new_hour_jun['cor_rmse'] <mr_data_new_hour_jun['uc_rmse']).sum()
print ('Jun : ' + str(cnt) +':::'+ str(cnt/float(mr_data_new_hour_jun.shape[0])*100))

rmse_cor_jun=rmse_cor['2018-06-01':'2018-06-29']
plot_bars_rmse(rmse_cor_jun,'Mixing_Ratio','day_1','rmse',rmse_cor_jun.index.strftime('%Y%m')[0])
