...
metar_list=pd.read_csv('/home/vkvalappil/Data/workspace/pythonScripts/metar_surf.csv',header=None)

for loc in metar_list.iloc[:,1]:
    print(loc)
    metar_file=main+'/wyoming/'+date[0:6]+'/'+loc+'_surf_'+date[0:8]+'.csv'
    outFile=main+'/wyoming/'+date[0:6]+'/'+loc+'_surf_mr'+date[0:8]+'.csv'
