#!/usr/bin/python
# script for sending fog alert from Seviri Dust mask for Abu Dhabi airport.
...
inp='/home/vkvalappil/RGB_masks_tif/MASKS/'
 
shp_file=main+'/alert/alert/abudhabi_100km.shp' ; 
